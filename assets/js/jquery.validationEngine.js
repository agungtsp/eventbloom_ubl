...
(function($) {
    ...
    var methods = {
            ...
            for (var i = 0; i < rules.length; i++) {
                ...
                switch (rules[i]) {
                    ...
                    case "equals":
                        ...
                        break;
					case "cekDbPass":
                        errorMsg = methods._cekDbPass(field, rules, i, options);
                        break;
					case "cekPass":
                        errorMsg = methods._cekPass(field, rules, i, options);
                        break;
                    case "funcCall":
         ...
         * @return an error string if validation failed
         */
		_cekDbPass: function(field, rules, i, options) {
            var equalsField = rules[i + 1];

            if (field.attr('value') != $("#" + equalsField).attr('value'))
                return options.allrules.cekDbPass.alertText;
        },
		
		_cekPass: function(field, rules, i, options) {
            var equalsField = rules[i + 1];

            if (field.attr('value') != $("#" + equalsField).attr('value'))
                return options.allrules.cekPass.alertText;
        },
